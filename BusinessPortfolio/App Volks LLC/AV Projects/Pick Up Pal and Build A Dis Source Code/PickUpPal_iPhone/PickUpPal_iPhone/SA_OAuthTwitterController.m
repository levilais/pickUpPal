...
- (void) gotPin: (NSString *) pin {
	...
	[self performSelector: @selector(dismissModalViewControllerAnimated:) withObject: (id) kCFBooleanTrue afterDelay: 3.0];
}
...
- (void) loadView {
	...
	if ( UIInterfaceOrientationIsLandscape( self.orientation ) ) {
		...
		_backgroundView.frame =  CGRectMake(0, 44, 320, 372);
